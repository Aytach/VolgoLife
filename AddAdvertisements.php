...
<div class="well">
	<div >
		...
		<form novalidate name="myForm" action="Add.php" onsubmit="return validateForm()" method="post" >
			...
			<br>
			<input type="text" name="name" value=""  placeholder="Введите ваше название товара" >
			<br>
			<label for="price">Стоимость:</label>
			<br>
			<input type="price" name="price" value=""  placeholder="Введите стоимость выполнение работы" >
			<br>
			...
			<br>
			<label for="email time">E-mail:</label>
			<br>
